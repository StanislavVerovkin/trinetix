...
export class MockDataService {
  ...
  */
  contentData: ContentModel = {
    ...
    contentText: ' We launch different types of platforms and operating systems using distinguishes of every platform or operating system as adventage and a powerful tool.',
    contentFooterText: '',
    content: [
      {
        image: '../../../assets/images/content-images/image-1.png',
        title: 'Mobile Apps',
        text: 'We are a nimble team of designers, developers, and strategists who are passionate about helping our clientsachieve their goals and grow their brands.'
      },
      {
